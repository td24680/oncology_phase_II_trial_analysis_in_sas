...
proc import datafile="&proj/data/raw/demographics.csv"
    out=demographics
    dbms=csv
    replace;
    guessingrows=max;
...
proc import datafile="&proj/data/raw/tumor_measurements.csv"
    out=tumor
    dbms=csv
    replace;
    guessingrows=max;
...
proc import datafile="&proj/data/raw/adverse_events.csv"
    out=adverse_events
    dbms=csv
    replace;
    guessingrows=max;
...
proc import datafile="&proj/data/raw/data_dictionary.csv"
    out=data_dictionary
    dbms=csv
    replace;
    guessingrows=max;
...
proc means data=subject_level_analysis
